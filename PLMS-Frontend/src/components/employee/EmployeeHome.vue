    ...
    <div class="employeepage">
      ...
      <nav class="site-header sticky-top py-1">
        <div class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <a class="py-2 d-none d-md-inline-block"   href="http://localhost:8087/#/employee/service_appointments">Your service appointments</a>
      ...
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
            <a  href="http://localhost:8087/#/manage_passes" class="btn btn-primary btn-lg btn-block big-high">Manage Passes</a>
            </div>
        </div>
      </div>
      </div>
