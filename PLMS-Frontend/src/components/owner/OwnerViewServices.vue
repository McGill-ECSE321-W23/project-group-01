  ...
  <div>
    ...
    <div>
      ...
      <button type="button" class="btn btn-primary"
        :disabled="!createServiceNameInput || !createCostInput || !createLengthInput" @click="createService()">Create
        Service</button>
    ...
    <div>
      ...
      <button type="button" class="btn btn-primary"
        :disabled="!editServiceNameInput || !editCostInput || !editLengthInput" @click="editService()">Edit
        Service</button>
    ...
    <div>
      ...
      <button type="button" :disabled="!deleteServiceInput" class="btn btn-danger" @click="deleteService()">Delete
        Service</button>
...
export default {
  ...
  created() {
    // load all the services in the DB on creation
    this.getAllServices()
  },
  ...
  methods: {
    ...
    // use the inputs from the from to create a new service
    createService() {
      const request = {
    ...
    // edit the details of an already existing service
    editService() {
      const request = {
    ...
    // delete an already offered service
    deleteService() {
    ...
    // get all the services in the DB (their details and a separate list with just their PKs)
    getAllServices() {
