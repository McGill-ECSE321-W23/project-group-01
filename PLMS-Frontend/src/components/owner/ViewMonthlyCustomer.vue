        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr v-for="(customer, index) in customers" :key="index" @click="handleRowClick(customer)"
                  @mouseover="handleRowHover(customer)" @mouseout="handleRowHover(null)"
                  :class="{ 'row-highlighted': customer === hoveredCustomer, 'row-selected': customer === selectedCustomer }">
                  <td>{{ customer.name }}</td>
...
export default {
  ...
  methods: {
    ...
    // get a list of all the customers in the system and their acct details
    ...
    // get a monthly customer by email
    ...
    // update the account details of a monthly customer
