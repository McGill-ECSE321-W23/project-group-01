        ...
        <div class="col-sm-10">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <td>
                  <input type="text" v-model="IDTextInput" @keyup.enter="handleIDInput" placeholder="Search by ID"
                    @focus="clearIDTextField()" />
                </td>

                <td>
                  <input type="text" v-model="customerEmailTextInput" @keyup.enter="handleEmailInput"
                ...
                <td><select id="floor" v-model="editFloorInput" @change="handleFloorSelect($event.target.value)">
                    ...
                    <option v-for="(floor, index) in floorNumbers.sort((a, b) => a - b)" :key="index">{{ floor }}
                    </option>
                  </select></td>
                <td></td>
                <td></td>
