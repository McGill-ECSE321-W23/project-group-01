    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-10">
          ...
          <button type="button" class="btn btn-success btn-sm" v-b-modal.edit-employee-modal
            :disabled="selectedEmployee === null">Update</button>
          <button type="button" class="btn btn-success btn-sm" :disabled="selectedEmployee === null"
            @click="onViewSchedule(selectedEmployee)"> View Schedule</button>
          <button type="button" class="btn btn-danger btn-sm" :disabled="selectedEmployee === null"
            @click="onDeleteEmployee(selectedEmployee)"> Delete </button>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr v-for="(employee, index) in employees" :key="index" @click="handleRowClick(employee)"
                @mouseover="handleRowHover(employee)" @mouseout="handleRowHover(null)" :class="{
                  'row-highlighted': employee === hoveredEmployee,
      ...
      <b-modal ref="addEmployeeModal" id="employee-modal" title="Add a new employee" hide-footer>
        <b-form @submit="onSubmit" @reset="onReset" class="w-100">
          <b-form-group id="form-name-group" label="Name:" label-for="form-name-input">
            <b-form-input id="form-name-input" type="text" v-model="addEmployeeForm.name" required
              placeholder="Enter name">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-email-group" label="Email:" label-for="form-email-input">
            <b-form-input id="form-email-input" type="email" v-model="addEmployeeForm.email" required
              placeholder="Enter email">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-password-group" label="Password:" label-for="form-password-input">
            <b-form-input id="form-password-input" type="password" v-model="addEmployeeForm.password" required
              placeholder="Enter password">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-job-title-group" label="Job Title:" label-for="form-job-title-input">
            <b-form-input id="form-job-title-input" type="text" v-model="addEmployeeForm.jobTitle" required
              placeholder="Enter job title">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-hourly-wage-group" label="Hourly Wage:" label-for="form-hourly-wage-input">
            <b-form-input id="form-hourly-wage-input" type="number" v-model="addEmployeeForm.hourlyWage" required
      ...
      <b-modal ref="editEmployeeModal" id="edit-employee-modal" title="Edit employee" hide-footer>
        <b-form @submit="onSubmitUpdate" @reset="onReset" class="w-100">
          <b-form-group id="form-name-group" label="Name:" label-for="form-name-input">
            <b-form-input id="form-name-input" type="text" v-model="editEmployeeForm.name"
              :placeholder="selectedEmployee ? selectedEmployee.name : 'Enter Name: '">
            </b-form-input>
          </b-form-group>

          <b-form-group id="form-password-group" label="Password:" label-for="form-password-input">
            <b-form-input id="form-password-input" type="password" v-model="editEmployeeForm.password"
              :placeholder="selectedEmployee ? selectedEmployee.password : 'Enter Password: '">
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-job-title-group" label="Job Title:" label-for="form-job-title-input">
            <b-form-input id="form-job-title-input" type="text" v-model="editEmployeeForm.jobTitle"
              :placeholder="selectedEmployee ? selectedEmployee.jobTitle : 'Enter Job Title:'">

            </b-form-input>
          </b-form-group>
          <b-form-group id="form-hourly-wage-group" label="Hourly Wage:" label-for="form-hourly-wage-input">
            <b-form-input id="form-hourly-wage-input" type="number" v-model="editEmployeeForm.hourlyWage"
      ...
      <b-modal ref="ServiceAppointmentModal" id="serviceAppointments-modal" title="Employee Scheduled Appointments"
        hide-footer>
        <table>
          <thead>
            <tr>
...
export default {
  ...
  methods: {
    ...
    // Edit the details of an employees account
    ...
    // Used for deleting an employees account (ie firing)
    ...
    // view all the appointments for a particular employee
    ...
    // used for resetting all the fields in each modal input
    initForm() {
    ...
    // selecting employees from the table
    ...
    /*
      LINKS TO OTHER OWNER VIEW PAGES
    */
    async Home() {
