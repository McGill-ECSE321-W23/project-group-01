...
public class ParkingLotServiceTests {
    ...
    public void testGetValidParkingLot(){
	  ...
	  Time closingTime = new Time(1, 0, 0);
      double largeSpotFee = 25;
      double smallSpotFee = 3;
      double smallMonthlyFlatFee = 2;
      double largeMonthlyFlatFee = 2;
      ParkingLot parkingLot = new ParkingLot(openingTime, closingTime, largeSpotFee, smallSpotFee, monthlyFlatFee);
