...
import ca.mcgill.ecse321.PLMS.dto.FloorPostRequestDto;
import ca.mcgill.ecse321.PLMS.dto.FloorPutRequestDto;
...
public class FloorController {
   ...
   */
  @PostMapping("/floor")
  public ResponseEntity<FloorResponseDto> createFloor(@Valid @RequestBody FloorPostRequestDto floorDto){
  ...
  public ResponseEntity<FloorResponseDto> updateFloorInfo(@PathVariable int floorNumber, @RequestBody @Valid FloorPutRequestDto floorDto){
    Floor floor = floorDto.toModel();
